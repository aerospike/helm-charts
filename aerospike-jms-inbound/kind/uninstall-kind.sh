...
echo "Cleaning up JMS Inbound integration test environment..."
...
kubectl --namespace aerospike-test delete secret tls-certs-jms-inbound 2>/dev/null || true

# Delete RBAC resources
kubectl delete clusterrolebinding aerospike-cluster-jms-inbound-test 2>/dev/null || true
...
# Delete Kind cluster
kind delete cluster --name jms-inbound-test-cluster 2>/dev/null || true
