...
./tests/deploy-test.sh --release-name test-jms-outbound-cleartext --values examples/clear-text/as-jms-outbound-values.yaml
```
...
# Or with custom release name
./tests/deploy-test.sh --release-name test-jms-outbound-tls --values examples/tls/as-jms-outbound-tls-values.yaml
```
...
./tests/deploy-test.sh --uninstall --namespace aerospike-test --release-name test-jms-outbound-cleartext
